...
namespace NUnit.TestsNFL_Android_IOS.Android_Pages
{
    public static class NFLOriginals
    {
        ...
        public static string GamePreviewsWeek6 { get; set; } = "//*[contains(text(),'Game Previews Week')]"; 
        ...
        public static string AmericansGame { get; set; } = "(//*[@class='android.widget.GridLayout']/*/*/*/*[@id='card_nflnetwork_title' and @height>0 and ./parent::*[(./preceding-sibling::* | ./following-sibling::*)[@height>0]]])[3]";
